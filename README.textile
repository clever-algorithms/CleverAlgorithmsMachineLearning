h1. Clever Algorithms: Machine Learning Programming Recipes 
...
Jason Brownlee, *Clever Algorithms: Machine Learning Programming Recipes*, Lulu, (Coming Soon)

h3. Technical Reports

The content for the book is being developed as a series of technical reports. The book is the final outcome for the project, and all technical reports should be considered preliminary. 

h4. Overview

* Jason Brownlee. "Clever Algorithms: Machine Learning Project Overview":http://github.com/jbrownlee/CleverAlgorithmsMachineLearning/raw/master/workspace/release/techreport-20110207-1.pdf . Technical Report CA-TR-20110207-1, The Clever Algorithms Project http://www.CleverAlgorithms.com, February 2011.
* Jason Brownlee. "Clever Algorithms: A Gentle Introduction to Machine Learning". Technical Report CA-TR-20110211-1, The Clever Algorithms Project http://www.CleverAlgorithms.com, February 2011.
* Jason Brownlee. "Clever Algorithms: Machine Learning Algorithm Selection". Technical Report CA-TR-20110213-1, The Clever Algorithms Project http://www.CleverAlgorithms.com, February 2011.
