h1. Clever Algorithms: Machine Learning

h2. Overview

The Clever Algorithms: Machine Learning project is an effort to describe a large number of algorithmic techniques from the the field of Machie Learning in a complete, consistent, and centralized manner such that they are accessible, usable, and understandable. 
