...
\lstinputlisting[firstline=7,language=r,caption={Example of Linear Discriminant Analysis in R using the \texttt{lda()} function in the \texttt{MASS} package.}, label=mass_linear_discriminant_analysis]{../src/algorithms/regression/mass_linear_discriminant_analysis.R}
