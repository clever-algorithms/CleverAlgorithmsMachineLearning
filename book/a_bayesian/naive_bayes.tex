...
% code listing
\lstinputlisting[firstline=7,language=r,caption={Example of Naive Bayes in R using the \texttt{naiveBayes()} function of the \texttt{e1071} package.}, label=e1071_naive_bayes]{../src/algorithms/bayes/e1071_naive_bayes.R}

Other packages that provide an implementation of Naive Bayes include the \texttt{predbayescor} package and the \texttt{klaR} package.
