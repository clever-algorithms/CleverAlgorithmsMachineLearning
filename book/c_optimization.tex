...
\newpage\begin{bibunit}\input{book/a_optimization/golden_section_search}\putbib\end{bibunit}
\newpage\begin{bibunit}\input{book/a_optimization/nelder_mead}\putbib\end{bibunit}
\newpage\begin{bibunit}\input{book/a_optimization/gradient_descent}\putbib\end{bibunit}
\newpage\begin{bibunit}\input{book/a_optimization/conjugate_gradient}\putbib\end{bibunit}
\newpage\begin{bibunit}\input{book/a_optimization/bfgs}\putbib\end{bibunit}
