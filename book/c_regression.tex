...
\newpage\begin{bibunit}\input{a_regression/ridge_regression}\putbib\end{bibunit}
...
\newpage\begin{bibunit}\input{a_regression/linear_discriminant_analysis}\putbib\end{bibunit}
