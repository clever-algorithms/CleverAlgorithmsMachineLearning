...
\newpage\begin{bibunit}\input{book/a_regression/ordinary_least_squares_regression}\putbib\end{bibunit}
\newpage\begin{bibunit}\input{book/a_regression/logistic_regression}\putbib\end{bibunit}
\newpage\begin{bibunit}\input{book/a_regression/stepwise_regression}\putbib\end{bibunit}
\newpage\begin{bibunit}\input{book/a_regression/multivariate_adaptive_regression_splines}\putbib\end{bibunit}
\newpage\begin{bibunit}\input{book/a_regression/locally_estimated_scatterplot_smoothing}\putbib\end{bibunit}
