...
% sections
\newpage\begin{bibunit}\input{book/c_advanced/plotting}\putbib\end{bibunit}
\newpage\begin{bibunit}\input{book/c_advanced/statistics}\putbib\end{bibunit}
\newpage\begin{bibunit}\input{book/c_advanced/model_tuning}\putbib\end{bibunit}
\newpage\begin{bibunit}\input{book/c_advanced/model_verification}\putbib\end{bibunit}
