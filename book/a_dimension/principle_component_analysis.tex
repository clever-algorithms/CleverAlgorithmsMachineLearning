...
The example uses the \texttt{prcomp()} function in the \texttt{stats} core package.
...
% other packages
The \texttt{stats} package also provides the \texttt{princomp} and \texttt{cmdscale} functions for computing a PCA.
