...
% listing
Listing~\ref{mass_sammon_mapping} provides a code listing of the Sammon Mapping method in R.
% algorithm and package
The example uses the \texttt{sammon()} function in the \texttt{MASS} package.
...
% code listing
\lstinputlisting[firstline=7,language=r,caption={Example of Sammon Mapping in R using the \texttt{sammon()} function of the \texttt{MASS} package.}, label=mass_sammon_mapping]{../src/algorithms/dimension/mass_sammon_mapping.R}
