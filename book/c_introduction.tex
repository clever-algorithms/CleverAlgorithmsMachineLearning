...
% sections
\input{book/c_introduction/machine_learning}
\input{book/c_introduction/problem_domains}
\input{book/c_introduction/considerations}
\input{book/c_introduction/organization}
\input{book/c_introduction/further_reading}
