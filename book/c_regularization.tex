...
\newpage\begin{bibunit}\input{book/a_regularization/ridge_regression}\putbib\end{bibunit}
\newpage\begin{bibunit}\input{book/a_regularization/lasso}\putbib\end{bibunit}
\newpage\begin{bibunit}\input{book/a_regularization/elastic_net}\putbib\end{bibunit}
